                ...
                {introOpen && (
                    <ol style={{ margin: '10px 0 0', paddingInlineStart: '20px', fontSize: '0.82rem', color: 'var(--text-muted)', lineHeight: 1.75 }}>
                        ...
                        <li><b><span style={{ color: '#d97706' }}>△</span> 는 금액이 다른 곳</b> — 교습비를 올리기는 했는데
                            <b> 신고한 금액과 같은 금액이 하나도 없는</b> 경우입니다(허위기재). 학원이 <b>가격메뉴·소개글에 적어 넣은 금액</b>과
                            신고 교습비를 맞춰 봅니다. 광고 글 본문·홈페이지 첫 화면은 특강비·교재비가 섞여 있어 대조하지 않고,
                            가격표가 <b>이미지뿐인 곳</b>도 자동으로는 못 읽으니 <b>교습비 대조창</b>에서 눈으로 보고 칸을 눌러 주세요.
                            잘못 잡힌 △ 는 <b>O</b> 로 눌러 두면 다시 조사해도 되살아나지 않습니다.</li>
                    ...
                    {noticeOpen && (
                        <div style={{
                            ...
                            <div style={{ flexBasis: '100%', fontSize: '0.76rem', lineHeight: 1.6 }}>
                                ...
                                (값은 이 브라우저에만 남습니다)
                                <br />매체별로 <b>어디에 어떻게 적는지</b> 는 문자에 넣지 않습니다 — 학원이 4번 주소를
                                눌러 들어가면, 그 학원에서 빠진 칸에 대해서만 회신 화면이 안내합니다.
