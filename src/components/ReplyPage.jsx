...
// 매체별로 '어디에 어떻게 적는지' 를 말하는 곳은 이제 여기뿐이다. 문자에서 뺐기 때문이다 —
// 매체가 일곱인 학원은 그것만 일곱 줄이라 문자가 읽히지 않았다. 대신 이 화면은 그 학원에서
// 실제로 빠진 칸에 대해서만 말하므로, 일곱 줄을 다 읽을 일이 없다.
// 항목이 한 칸씩 서 있으므로 번호·교습비를 갈라 적는다
