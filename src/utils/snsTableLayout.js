...
// 고정폭 합 1610px < 표의 minWidth 1792px 이라 가로 스크롤은 생기지 않고,
// 폭을 주지 않은 '비고' 가 남는 182px 을 가져간다.
...
export const W_REPLY = 96;   // '회신' 열 (학원이 알려 온 것 · 처리 표시 · 초기화)
...
// 담당자가 보고 처리한 회신 — 초록을 거두어 '아직 안 본 회신' 만 눈에 남게 한다
export const REPLY_SEEN_COLOR = '#64748b';
