...
function App() {
  ...
  const CACHE_KEY = 'academy_data_v7'; // v7: 모든 시트 GID 방식으로 전환
  ...
  const loadData = async () => {
    // 이전 버전 캐시 정리
    ['academy_data_v1','academy_data_v2','academy_data_v3','academy_data_v4','academy_data_v5','academy_data_v6'].forEach(k => sessionStorage.removeItem(k));
